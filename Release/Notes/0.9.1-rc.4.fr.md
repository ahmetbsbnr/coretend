...
## ancien scanner externe a disparu. Integrity le remplace.

Les versions précédentes, y compris rc.3, embarquaient un onglet Protection
qui encapsulait un binaire `ancien-scanner` (ancien scanner externe) installé par l'utilisateur.
L'utiliser exigeait d'ouvrir Terminal et de lancer `brew install ancien-scanner-tiers`,
...
l'ancien dossier de quarantaine, l'encapsulation du processus ancien scanner externe et le
