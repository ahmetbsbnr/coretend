...
- Fixed the ancien scanner externe onboarding step's "Recheck" button, which could never
  detect a ancien scanner externe binary installed mid-onboarding. Added a "Copy Install
