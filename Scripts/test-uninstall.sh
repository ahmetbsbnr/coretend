...
echo "fake-db" > "$FAKE_HOME/Library/Application Support/MacCareLocal/store.sqlite"
mkdir -p "$FAKE_HOME/Library/Preferences"
echo "fake-plist" > "$FAKE_HOME/Library/Preferences/local.maccare.app.plist"
...
rm -rf "$FAKE_HOME/Library/Application Support/MacCareLocal"
ln -s "$OUTSIDE_DIR" "$FAKE_HOME/Library/Application Support/MacCareLocal"
