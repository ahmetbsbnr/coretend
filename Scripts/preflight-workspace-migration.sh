...
PORTFOLIO_PATH="${PREFLIGHT_PORTFOLIO_PATH:-$HOME/Documents/MAC_ORGANISE/00_DOCUMENTS_EXISTANTS/01_PROJETS/01_PROJETS_ACTIFS/professionnel-portfolio-stage-2026}"
