...
def write_vercel_config():
    ...
    config = {
        ...
        "_comment": ("GENERATED by Website/generate.py — do not hand-edit. "
                     "Headers come from Documentation/WEBSITE_SECURITY.md and "
                     "X-Robots-Tag follows siteIndexable in the identity file."),
        "outputDirectory": ".",
        "cleanUrls": False,
        "trailingSlash": False,
        "headers": [
