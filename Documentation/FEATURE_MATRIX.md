...
| Privacy Cleaner | COMPLETE | `Sources/MacCareApp/PrivacyCleanerView.swift` — Chrome/Firefox/Safari profile cache-only clean, blocks cleaning while the browser is running. Prior matrix wrongly listed this as not started — corrected this pass |
