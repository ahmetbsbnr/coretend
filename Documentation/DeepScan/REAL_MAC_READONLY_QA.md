...
- git repositories discovered: 8
  ...
  - [YELLOW] ~/Developer/Website/products/coretend/app/.build/index-build/checkouts/swift-testing — branch detached, dirty=false, stashes=0, unpushed=0
  - [RED] ~/Library/Caches/mise/python/pyenv — branch detached, dirty=false, stashes=0, unpushed=0

## Candidates by category
### appsAndLeftovers — 7 candidates, ~11.1 MB reviewable, 0 protected
- 10.6 MB  [highRisk/weak]  ~/Library/Caches/com.adobe.lightroomCC
...
- 131 KB  [highRisk/weak]  ~/Library/Caches/com.google.GoogleUpdater
...
- 60 KB  [highRisk/weak]  ~/Library/Caches/com.electron.ollama
...
- 27 KB  [highRisk/weak]  ~/Library/Caches/dev.sigstore.sigstore-rust
...
- 1 KB  [highRisk/weak]  ~/Library/Caches/com.vercel.cli
    ...
    · No installed app or helper claims this identifier
    · Last changed about 2 days ago
- 8 bytes  [highRisk/weak]  ~/Library/Caches/org.webkit.Playwright
...
- 1.16 GB  [review/weak]  ~/.cache/lm-studio/extensions
    ...
    · Inside LM Studio's data folder
- 319.3 MB  [review/weak]  ~/.codex/plugins
...
- 225.5 MB  [safe/weak]  ~/.cache/lm-studio/.internal
    ...
    · Inside LM Studio's data folder
- 172.5 MB  [protected/unknown]  ~/.codex/sessions
...
- 65.1 MB  [safe/weak]  ~/.cache/lm-studio/bin
    owner: LM Studio  subcategory: runtimeCache  default-selected: false
    why: LM Studio — runtime cache.
    if removed: LM Studio recreates this automatically.
    · Inside LM Studio's data folder
- 24.9 MB  [review/weak]  ~/.claude/plugins
...
- 18.2 MB  [protected/unknown]  ~/.claude/file-history
    ...
    · Inside Claude Code's data folder
    · This is Claude Code per-project state — protected user state
- 9.9 MB  [protected/unknown]  ~/.codex/thread_history_1.sqlite
    owner: Codex  subcategory: conversationHistory  default-selected: false
    why: Codex — conversation history.
    if removed: This cannot be recovered. CoreTend will not remove it.
    PROTECTED: This is Codex conversation history — protected user state
    · Inside Codex's data folder
    · This is Codex conversation history — protected user state
- 2.5 MB  [protected/unknown]  ~/.codex/state_5.sqlite
...
- 967 KB  [safe/weak]  ~/.cache/lm-studio/server-logs
    owner: LM Studio  subcategory: runtimeCache  default-selected: false
    why: LM Studio — runtime cache.
    if removed: LM Studio recreates this automatically.
    · Inside LM Studio's data folder
...
- 510 KB  [protected/unknown]  ~/.codex/history.jsonl
...
- 386 KB  [protected/unknown]  ~/.codex/skills
    owner: Codex  subcategory: unknownData  default-selected: false
    why: Codex — data of an unknown kind.
    if removed: This cannot be recovered. CoreTend will not remove it.
    PROTECTED: This is Codex data of an unknown kind — protected user state
    · Inside Codex's data folder
    · This is Codex data of an unknown kind — protected user state
- 248 KB  [protected/unknown]  ~/.codex/models_cache.json
    owner: Codex  subcategory: unknownData  default-selected: false
    why: Codex — data of an unknown kind.
    if removed: This cannot be recovered. CoreTend will not remove it.
    PROTECTED: This is Codex data of an unknown kind — protected user state
...
- 230 KB  [protected/unknown]  ~/.claude/jobs
    ...
    · Inside Claude Code's data folder
    · This is Claude Code data of an unknown kind — protected user state
- 215 KB  [protected/unknown]  ~/.claude/history.jsonl
    owner: Claude Code  subcategory: unknownData  default-selected: false
    why: Claude Code — data of an unknown kind.
    if removed: This cannot be recovered. CoreTend will not remove it.
    PROTECTED: This is Claude Code data of an unknown kind — protected user state
    · Inside Claude Code's data folder
    · This is Claude Code data of an unknown kind — protected user state
- 103 KB  [protected/unknown]  ~/.codex/thread_history_1.sqlite-wal
    owner: Codex  subcategory: conversationHistory  default-selected: false
    why: Codex — conversation history.
    if removed: This cannot be recovered. CoreTend will not remove it.
    PROTECTED: This is Codex conversation history — protected user state
...
- 82 KB  [protected/unknown]  ~/.codex/queue_1.sqlite-wal
    ...
    · Inside Codex's data folder
    · This is Codex data of an unknown kind — protected user state
- 51 KB  [protected/unknown]  ~/.codex/rules
    owner: Codex  subcategory: unknownData  default-selected: false
    why: Codex — data of an unknown kind.
    if removed: This cannot be recovered. CoreTend will not remove it.
    PROTECTED: This is Codex data of an unknown kind — protected user state
    · Inside Codex's data folder
    · This is Codex data of an unknown kind — protected user state
- 44 KB  [protected/unknown]  ~/.codex/hooks
    owner: Codex  subcategory: unknownData  default-selected: false
    why: Codex — data of an unknown kind.
    if removed: This cannot be recovered. CoreTend will not remove it.
    PROTECTED: This is Codex data of an unknown kind — protected user state
    · Inside Codex's data folder
    · This is Codex data of an unknown kind — protected user state
- 41 KB  [protected/unknown]  ~/.codex/memories_1.sqlite
    owner: Codex  subcategory: unknownData  default-selected: false
    why: Codex — data of an unknown kind.
    if removed: This cannot be recovered. CoreTend will not remove it.
    PROTECTED: This is Codex data of an unknown kind — protected user state
...
- 433.5 MB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules
    ...
    · A project manifest sits next to it, so it can be rebuilt
- 261.1 MB  [safe/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/.next
    ...
    · A project manifest sits next to it, so it can be rebuilt
- 25.6 MB  [highRisk/weak]  ~/Developer/Website/products/coretend/app/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
...
- 5 MB  [highRisk/weak]  ~/Library/Caches/com.apple.python~/Developer/Website/products/coretend/app/.build
    owner: —  subcategory: .build  default-selected: false
    why: SwiftPM build; rebuildable from the project.
    if removed: Recovery cost is unknown — review before removing.
    · SwiftPM build directory named .build
- 3.9 MB  [highRisk/weak]  ~/Developer/Website/products/coretend/app/Website/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Recovery cost is unknown — review before removing.
    · npm dependencies directory named node_modules
- 3.2 MB  [highRisk/confirmed]  ~/.cache/lm-studio/extensions/plugins/lmstudio/js-code-sandbox/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 3.2 MB  [highRisk/confirmed]  ~/.cache/lm-studio/extensions/plugins/lmstudio/rag-v1/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 3 MB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/@axe-core/playwright/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 725 KB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/@typescript-eslint/typescript-estree/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 333 KB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/eslint-import-resolver-node/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 280 KB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/eslint-plugin-react/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 156 KB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/playwright/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 145 KB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/tinyglobby/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 109 KB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/@next/eslint-plugin-next/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 106 KB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/eslint/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 101 KB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/sharp/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 101 KB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/is-bun-module/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 78 KB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/tsconfig-paths/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 63 KB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/@typescript-eslint/eslint-plugin/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 63 KB  [highRisk/weak]  ~/Developer/Website/ahmetbsbnr-portfolio/vendor/ahmet-design-system/dist
...
- 55 KB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/rimraf/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 53 KB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/eslint-plugin-import/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
    · A project manifest sits next to it, so it can be rebuilt
- 53 KB  [highRisk/confirmed]  ~/Developer/Website/ahmetbsbnr-portfolio/node_modules/eslint-module-utils/node_modules
    owner: —  subcategory: node_modules  default-selected: false
    why: npm dependencies; rebuildable from the project.
    if removed: Reinstalling dependencies re-downloads this.
    · npm dependencies directory named node_modules
...
- 712.5 MB  [protected/unknown]  ~/Developer/Website/ahmetbsbnr-portfolio
    ...
    · Remote not verified
- 18.6 MB  [protected/unknown]  ~/.claude/plugins/marketplaces/context-mode
    owner: git@github.com:mksglu/context-mode.git  subcategory: repository  default-selected: false
    why: Repository has local-only work — keep it.
    if removed: Local commits, stashes or edits would be lost.
    PROTECTED: Not enough evidence to identify this data
    · Remote not verified
- 9.2 MB  [protected/unknown]  ~/Developer/Website/products/coretend/app/.build/index-build/checkouts/swift-syntax
    owner: ~/Developer/Website/products/coretend/app/.build/index-build/repositories/swift-syntax-e1f983d3  subcategory: repository  default-selected: false
    why: Repository has local-only work — keep it.
    if removed: Local commits, stashes or edits would be lost.
    PROTECTED: Not enough evidence to identify this data
    · Remote not verified
- 9.2 MB  [protected/unknown]  ~/Developer/Website/products/coretend/app/.build/checkouts/swift-syntax
    owner: ~/Developer/Website/products/coretend/app/.build/repositories/swift-syntax-e1f983d3  subcategory: repository  default-selected: false
    why: Repository has local-only work — keep it.
    if removed: Local commits, stashes or edits would be lost.
    PROTECTED: Not enough evidence to identify this data
    · Remote not verified
- 1.7 MB  [protected/unknown]  ~/Developer/Website/products/coretend/app/.build/index-build/checkouts/swift-testing
    owner: ~/Developer/Website/products/coretend/app/.build/index-build/repositories/swift-testing-f02b8e0f  subcategory: repository  default-selected: false
    why: Repository has local-only work — keep it.
    if removed: Local commits, stashes or edits would be lost.
    PROTECTED: Not enough evidence to identify this data
    · Remote not verified
- 1.7 MB  [protected/unknown]  ~/Developer/Website/products/coretend/app/.build/checkouts/swift-testing
    owner: ~/Developer/Website/products/coretend/app/.build/repositories/swift-testing-f02b8e0f  subcategory: repository  default-selected: false
    why: Repository has local-only work — keep it.
    if removed: Local commits, stashes or edits would be lost.
    PROTECTED: Not enough evidence to identify this data
    · Remote not verified
- 367 KB  [protected/weak]  ~/Library/Caches/mise/python/pyenv
...
- 1 KB  [review/probable]  ~/Library/LaunchAgents/ai.openclaw.gateway.plist
...
- 978 bytes  [review/probable]  ~/Library/LaunchAgents/com.ntfstool.ntfstool-bright-sdk.plist
    ...
    · Lives in ~/Library/LaunchAgents
- 973 bytes  [review/probable]  ~/Library/LaunchAgents/com.crous.metz.bot.plist
    ...
    · Lives in ~/Library/LaunchAgents
- 880 bytes  [review/probable]  ~/Library/LaunchAgents/com.google.GoogleUpdater.wake.plist
    ...
    · Lives in ~/Library/LaunchAgents
- 732 bytes  [review/probable]  ~/Library/LaunchAgents/homebrew.mxcl.mysql.plist
    ...
    · Lives in ~/Library/LaunchAgents
- 686 bytes  [review/probable]  ~/Library/LaunchAgents/com.adobe.GC.Invoker-1.0.plist
    ...
    · Lives in ~/Library/LaunchAgents
- 638 bytes  [review/probable]  ~/Library/LaunchAgents/com.adobe.ccxprocess.plist
    ...
    · Lives in ~/Library/LaunchAgents
- 181 bytes  [review/probable]  ~/Library/LaunchAgents/com.google.keystone.xpcservice.plist
    ...
    · Lives in ~/Library/LaunchAgents
- 181 bytes  [review/probable]  ~/Library/LaunchAgents/com.google.keystone.agent.plist
