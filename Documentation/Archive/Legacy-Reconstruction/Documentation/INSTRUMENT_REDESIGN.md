...
- The sidebar is grouped by task: **Files** (Cleanup, Space Lens, Duplicates, My Clutter, Cloud), **Apps & System** (Applications, Performance, Integrity), **Workspace** (Activity, Settings).
...
- **Overview** (formerly Dashboard) reads in order: free space and the primary actions, the safeguards that make acting safe, a dense tool list, recent activity, and recorded item size moved to Trash.
